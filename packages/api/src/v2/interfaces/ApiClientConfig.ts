...
export interface ApiClientConfig {
  ...
  /**
   * Custom fetch implementation for making API requests.
   *
   * This allows you to provide a custom fetch function, which can be useful for:
   * - Testing with mocked fetch implementations
   * - Using advanced features like request interception or retries
   * - Integrating with libraries that require a specific fetch implementation
   */
  fetch?: typeof fetch;
}
