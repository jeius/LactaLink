...
import { emitTransactionCreatedEvent } from './hooks/emitTransactionCreatedEvent';
...
export const Transactions: CollectionConfig<'transactions'> = {
  ...
  hooks: {
    ...
    afterChange: [emitTransactionCreatedEvent],
  },
  fields: [
    {
      ...
      fields: [
        {
          ...
          required: true,
          defaultValue: TRANSACTION_STATUS.PENDING_DELIVERY_CONFIRMATION.value,
