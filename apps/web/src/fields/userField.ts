 ...
 * @defaultValue admin.description='The user who created this entry. (Auto-generated by the current authenticated user, safe to ignore)'
 */
 ...
 * @defaultValue admin.position='sidebar'
 * @defaultValue admin.readOnly=true
 * @defaultValue admin.description='The profile of the user who created this entry. (Auto-generated by the current authenticated user, safe to ignore)'
 */
