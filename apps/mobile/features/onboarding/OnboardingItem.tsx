...
export const OnboardingItem: CarouselRenderItem<OnboardingData> = (args) => {
  ...
  return (
    <VStack key={index}>
      <Box className="mx-auto h-72 p-4 pb-0">
        <Image
          alt={image.alt}
          source={image.source}
          contentFit="contain"
      ...
      <VStack space="xl" className="items-center p-5">
        ...
        <Text className="font-JakartaMedium text-base text-primary-700">{subtitle}</Text>

        <Text italic size="lg" className="text-typography-950">
          {description}
        </Text>
