...
import { COLLECTION_MODES, DELIVERY_OPTIONS, PREFERRED_STORAGE_TYPES } from '@lactalink/enums';
...
interface DonationReviewProps extends VStackProps {
  data: Omit<DonationSchema, 'donor'> & { delivery?: DeliveryCreateSchema | null };
}
export default function DonationReview({ data, space = 'sm', ...props }: DonationReviewProps) {
  const {
    deliveryPreferences,
