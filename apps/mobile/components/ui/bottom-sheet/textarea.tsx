...
Textarea.displayName = 'BottomSheetTextarea';
TextareaInput.displayName = 'BottomSheetTextareaInput';

export { Textarea as BottomSheetTextarea, TextareaInput as BottomSheetTextareaInput };
