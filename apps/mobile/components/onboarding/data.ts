...
export const onboardingData: OnboardingData[] = [
  ...
  },
  {
    ...
    image: { alt: 'Mother Donor', uri: ONBOARDING_IMAGES.onboarding2 },
    footer: [
      {
  ...
  },
  {
    ...
    image: { alt: 'Delivery Man', uri: ONBOARDING_IMAGES.onboarding3 },
    footer: [
      {
        icon: SearchIcon,
        iconPosition: 'left',
  ...
  },
  {
    ...
    image: { alt: 'Mom Nourishing', uri: ONBOARDING_IMAGES.onboarding4 },
  },
];
