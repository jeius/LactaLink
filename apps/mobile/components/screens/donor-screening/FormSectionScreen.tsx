...
import { useScreeningFormSection } from '@/features/donor-screening/hooks/useScreeningFormSection';
...
export default function FormSectionScreen() {
  const { sectionId } = useLocalSearchParams<{ sectionId: string }>();
  const isFocused = useIsFocused();

  const { formMethods, fields, description, title } = useScreeningFormSection({
    sectionID: sectionId,
  });
