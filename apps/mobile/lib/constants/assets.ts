...
export const IMAGE_ASSETS = {
  ...
  'individual_0.75x': require('../../assets/images/0_75x/individual_type.png'),
  hospital: require('../../assets/images/1x/hospital_type.png'),
  'hospital_0.75x': require('../../assets/images/0_75x/hospital_type.png'),
  milkBank: require('../../assets/images/1x/milk_bank_type.png'),
  'milkBank_0.75x': require('../../assets/images/0_75x/milk_bank_type.png'),
  ...
  'error404_0.75x': require('../../assets/images/0_75x/error_404.png'),
  noData: require('../../assets/images/1x/no_data.png'),
  'noData_0.75x': require('../../assets/images/0_75x/no_data.png'),
  deliveryGuy: require('../../assets/images/1x/delivery_guy.png'),
  'deliveryGuy_0.75x': require('../../assets/images/0_75x/delivery_guy.png'),
  pumpingMilk: require('../../assets/images/1x/pumping_milk.png'),
  'pumpingMilk_0.75x': require('../../assets/images/0_75x/pumping_milk.png'),
  idVerification: require('../../assets/images/1x/verify_identity.png'),
  'idVerification_0.75x': require('../../assets/images/0_75x/verify_identity.png'),
