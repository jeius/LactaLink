...
export default function Layout() {
  ...
  const message = 'You have unsaved changes. Please save or reset before going back.';

  usePreventBackPress(isFormDirty, message);
    ...
    <FormProvider {...form}>
      <Stack
        screenOptions={{
          ...
          headerLeft: () => <HeaderBackButton enable={!isFormDirty} message={message} />,
        }}
      />
